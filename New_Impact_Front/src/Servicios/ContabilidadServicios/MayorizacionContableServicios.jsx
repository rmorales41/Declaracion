...
// Función para la mayorizacion Contable
const mayorizacionContable = (codigo_compania, fecha_mayorizacion) => {
...
//Hooks que devuelve
const MayorizacionContableServicios = {
  setAuthToken,
  mayorizacionContable,
};

export default MayorizacionContableServicios;