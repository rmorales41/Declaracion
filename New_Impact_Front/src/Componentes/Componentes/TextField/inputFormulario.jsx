...
const InputFormulario = ({
  classe, nombreLabel, titlelabel, icono, type, errores, id, name, titleInput, value,  onChange, onBlur, onKeyUp, 
  maxLength ,required, restricciones, editarONuevo, placeholder, onFocus, onMouseEnter, onMouseLeave, onClickSpan,
  classeSpan, disabled, onClick, min, max, step, ref, title, minLength, ancho, ondblclick
}) => {
