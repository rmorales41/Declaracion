...
const FormularioAsientosEditar = (props) => {
const { 
  manejoCambioImput,
  editar,
  asiento,
...
{/* --------------------------------------- Encabezados del Asiento --------------------------------------- */}  
                            <div className="card-body row g-3 needs-validation my-2 ">
                               ...
                               <InputFormulario
                                    ...
                                    onChange={eventoInputCodigoAsiento}
                                    minLength={11}
                                    required = {true}
                               />   
                              ...
                              <SelectAutoCompleteFormulario
                                    ...
                                    label={
                                      encabezadoAsiento.IDContabilidad_Tipo_Asiento 
                                        ? listaTipoAsiento.find(
                                            option => option.IDContabilidad_Tipo_Asiento === encabezadoAsiento.IDContabilidad_Tipo_Asiento
                                          )?.Descripcion 
                                        : "Seleccione una opción"
                                    } 
                                    ancho = {220} 
                                    defaultProps={propsTipoAsiento}
                                    onChange={(event, value) => eventoCambioDeSelectEncabezado(event, value, "IDContabilidad_Tipo_Asiento", valorTipoAsiento)}
                              ...
                              <TextAreaFormulario
                                    ...
                                    onChange={manejoCambioImputEncabezado}
                                    restricciones={restricciones}
                                    editarONuevo={props.editar}
                                    row={"1"}
                                    required = {true}
                              ...
                              <SwitchFormulario
                                    ...
                                    onChange={(isChecked) => {
                                      setEncabezadoAsiento(prevObjeto => ({
                                        ...prevObjeto,
...
{/* --------------------------------------- Detalles del Asiento --------------------------------------- */}  
                            <div className="card-body row g-3 needs-validation separadorForm ">
                                   ...
                                   <SelectAutoCompleteFormulario
                                    ...
                                    label={
                                      asiento.IDConfiguracion_Tipo_Documento 
                                        ? lista_tipo_Documento.find(
                                            option => option.IDConfiguracion_Tipo_Documento === asiento.IDConfiguracion_Tipo_Documento
                                          )?.Descripcion 
                                        : "Seleccione una opción"
                                    } 
                                    ancho = {220} 
                              ...
                              <SelectAutoCompleteFormulario
                                    ...
                                    restricciones={restricciones}
                                    editarONuevo={props.editar}
                                    valueAutocomplete={valorCatalogoSeleccionado ? valorCatalogoSeleccionado : null}
...
{/* --------------------------------------- boton guarda detalles del asientos --------------------------------------- */}  
...
export default FormularioAsientosEditar;
